    ...
    <>
      ...
      <div className="bg-[#050C1D] text-white px-6 sm:px-12 lg:px-24 py-12">
        ...
        <ul className="list-disc list-inside ml-10 mb-5">
          ...
          <li className="text-base md:text-lg leading-8">
            Geolocation Data (for service delivery)
          </li>
        </ul>

        <h3 className="text-xl leading-8 mb-2">
        ...
        <h3 className="text-xl leading-8 mb-2">c. Legal Obligations:</h3>
        <p className="text-base md:text-lg leading-8 mb-5">
        We may disclose your information when required by law or if we believe it is necessary to:
        </p>
        <ul className="list-disc list-inside ml-10 mb-5">
          <li className="text-base md:text-lg leading-8">
        ...
        <ul className="list-disc list-inside ml-10 mb-5">
          ...
          <li className="text-base md:text-lg leading-8">
          Disable cookies in your browser (though this may affect your experience on our site)
          </li>
          <li className="text-base md:text-lg leading-8">
