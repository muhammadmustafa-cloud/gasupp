...
const WhyChooseUs = () => {
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-14 my-28 mx-4 lg:mx-24">
        <div className="w-full lg:w-1/2 flex flex-col gap-7">
          <div className="flex relative">
            <span className="bg-[#41CB5B] h-[2px] w-[50px] top-4 absolute"></span>
            <h5 className="text-xl lg:text-2xl absolute text-[#41CB5B] font-normal uppercase tracking-wider left-16">
              Let&apos;s to Know Us
            </h5>
          </div>
          <h2 className="text-4xl lg:text-6xl font-medium blueColor mt-4">
            We Delivering The Best Global Refueling Solutions.
          </h2>
          <p className="text-lg lg:text-xl text-[#898a9c]">
          ...
          <div className="flex flex-col gap-4">
            <div className="container">
              ...
              <div className="skill-box">
                ...
                <div className="skill-bar">
                  <span className="skill-per css" style={{ width: "70%" }}>
              ...
              <div className="skill-box">
                ...
                <div className="skill-bar">
                  <span
                    className="skill-per javascript"
                    style={{ width: "80%" }}
                  >
        ...
        <div className="w-full lg:w-1/2">
          <div className="relative">
            ...
            <div className="absolute flex flex-col justify-center py-8 px-4 rounded-xl gap-2 items-center bg-[#41CB5B] text-white bottom-0">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold">5+</h2>
              <h6 className="text-md lg:text-lg font-medium">
                Years of Experience
              </h6>
            </div>
          </div>
      ...
      >
        <div className="bg-[#050C1D]   w-full h-full flex flex-col items-center opacity-80">
          <div className="flex relative mt-20 mr-0 mr-20">
            <span className="bg-[#41CB5B] h-[2px] w-[50px] top-4 right-4 absolute"></span>
            <h5 className="text-2xl absolute text-[#41CB5B]  font-normal w-48 tracking-wider ">
              Why Choose Us
            </h5>
          </div>
          <h2
            className={`md:text-5xl  text-3xl  text-center font-semibold blueColor text-white mt-12 w-full md:w-[20%]}`}
          >
            We offer perfect real Delivery Service
          </h2>
        </div>
      </div>
        ...
        <div className=" relative top-24">
          <div className="flex flex-wrap items-center justify-center gap-4  my-14">
            <div className="flex flex-col h-[300px] bg-white shadow-2xl w-[300px] rounded-2xl justify-center items-center px-2 py-8">
              ...
              <p className="text-base text-[#898a9c] mt-3 w-[80%] text-center">
                We help you find a architect by offering interior experience
              </p>
            </div>
            <div className="flex flex-col h-[300px] bg-white shadow-2xl w-[300px] rounded-2xl justify-center items-center px-2 py-8">
