    ...
    <>
      ...
      <div className="bg-[#050C1D] text-white px-24 py-12">
        ...
        <p className="text-lg leading-8 mb-5">
          At GasUpp, we are committed to providing a website and mobile app that
          is accessible to all users, including those with disabilities. We aim
          to comply with accessibility standards to ensure an inclusive
        ...
        <p className="text-lg leading-8 mb-5">
          We are working to ensure that our website and app meet or exceed the
          Web Content Accessibility Guidelines (WCAG) 2.1, Level AA. These
          guidelines have been developed to ensure digital content is accessible
          to individuals with disabilities, including people who use screen
          readers, keyboard navigation, or other assistive technologies.
        </p>
        ...
        <p className="text-lg leading-8 mb-5">
          We are continuously improving the accessibility of our digital
          properties and regularly updating our website and mobile app to
          enhance usability for all individuals. We encourage feedback from
